  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 w-full z-50 transition-all duration-500 ${
        isScrolled
          ? "bg-space-black/80 backdrop-blur-2xl border-b border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.5)]"
          : "bg-transparent pt-4"
      }`}
    >
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          >
            <span className="absolute inset-0 w-full h-full bg-linear-to-r from-cyber-red via-cyber-purple to-cyber-blue opacity-80 group-hover:opacity-100 transition-opacity" />
